...
class AccountsView extends PolymerElement {
  static get template() {
    return html`
 ...
 <div style="width:400px;padding:var(--lumo-space-l)">
  <vaadin-form-layout>
   <vaadin-form-item>
    ...
    <vaadin-text-field class="full-width" value="" id="name"></vaadin-text-field>
   </vaadin-form-item>
  </vaadin-form-layout>
...
customElements.define(AccountsView.is, AccountsView);
