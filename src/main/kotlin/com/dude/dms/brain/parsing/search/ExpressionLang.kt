...
fun main() {
    println(evaluate("true")) //shouldEqual true

    println(evaluate("1")) //shouldEqual 1
    println(evaluate("123")) //shouldEqual 123
    println(evaluate("\"\"")) //shouldEqual ""
    println(evaluate("\"abc\"")) //shouldEqual "abc"
    println(evaluate("\"a\\\"c\"")) //shouldEqual """a\"c"""
    println(evaluate("[]")) //shouldEqual emptyList<Any>()
    println(evaluate("[1]")) //shouldEqual listOf(1)
    println(evaluate("[1 + 2, 3 * 4]")) //shouldEqual listOf(3, 12)
    println(evaluate("[1, 2, 3]")) //shouldEqual listOf(1, 2, 3)
    println(evaluate("[[1]]")) //shouldEqual listOf(listOf(1))
    println(evaluate("[[1, 2], [3]]")) //shouldEqual listOf(listOf(1, 2), listOf(3))
}
