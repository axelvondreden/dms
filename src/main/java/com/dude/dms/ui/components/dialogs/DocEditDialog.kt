...
class DocEditDialog(builderFactory: BuilderFactory, private val doc: Doc, private val docService: DocService) : EventDialog<Doc>() {
    ...
    init {
        ...
        val tagDetails = Details("Tags", tagSelector).apply { element.style["width"] = "100%" }
        val attributeDetails = Details("Attributes", attributeValueContainer).apply { element.style["width"] = "100%" }
