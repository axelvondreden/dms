...
public class FormattingUtils {
     ...
     */
    public static final TemporalField WEEK_OF_YEAR_FIELD = WeekFields.of(Const.APP_LOCALE).weekOfWeekBasedYear();

    /**
     * 3 letter day of the week + day number. E.g: Mon 20
     */
    public static final DateTimeFormatter SHORT_DAY_FORMATTER = DateTimeFormatter.ofPattern("E d", Const.APP_LOCALE);

    /**
     * Full date format. E.g: 03.03.2001
     */
    public static final DateTimeFormatter FULL_DATE_FORMATTER = DateTimeFormatter.ofPattern("dd.MM.yyyy", Const.APP_LOCALE);

    /**
     * Formats hours with am/pm. E.g: 2:00 PM
     */
    public static final DateTimeFormatter HOUR_FORMATTER = DateTimeFormatter.ofPattern("h:mm a", Const.APP_LOCALE);
    ...
    public static String getFullMonthName(LocalDate date) {
        return date.getMonth().getDisplayName(TextStyle.FULL, Const.APP_LOCALE);
    }

    public static String formatAsCurrency(int valueInCents) {
        return NumberFormat.getCurrencyInstance(Const.APP_LOCALE).format(BigDecimal.valueOf(valueInCents, 2));
    }
